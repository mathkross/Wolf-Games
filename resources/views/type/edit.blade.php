...
@section('content')
<form action="{{route('type.update', $type->id)}}" method="POST" class="pb-5 pt-5">
    <div  class=" container pb-5 mt-5 form-row bg-light shadow p-3 mb-5 bg-light rounded-3 col-4">
        ...
        <div class="form-row col-md"> <!-- Nome da Categoria-->
            <label for="nomeType">Tipo</label>
            <input required type="text" class="form-control" id="nomeType" name="name" value="{{$type->name}}">
